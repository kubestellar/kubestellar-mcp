...
See kubestellar-mcp#783, which tracks adding an automated `if: failure()`
alert step (the prior tracker, #771, was closed as a duplicate of #694,
which was in turn closed as a duplicate of #771, leaving the gap
untracked until #783 was filed); until that lands, check for this manually:
