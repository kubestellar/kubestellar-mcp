...
Issues #694 and #771, which each documented this gap, were closed as
duplicates of each other and neither survives as an open tracker; see
kubestellar-mcp#783, which now tracks adding an automated `if: failure()`
