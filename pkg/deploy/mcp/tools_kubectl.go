...
// yamlToJSON converts YAML or JSON manifests into JSON for unstructured decoding.
...
// yamlToJSONBytes converts YAML or JSON bytes to JSON bytes.
func yamlToJSONBytes(y []byte) ([]byte, error) {
	return k8syaml.ToJSON(y)
}

// parseYAML parses YAML or JSON bytes into v.
