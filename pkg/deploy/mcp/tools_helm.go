...
// Only https:// is allowed. The hostname is resolved and any private,
// loopback, link-local, CGNAT, or cloud-metadata IP is rejected to prevent
// SSRF / cloud IMDS credential theft (#216).
