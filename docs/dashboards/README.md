...
`make dashboard-lint` is wired into CI via
[`.github/workflows/dashboard-alert-lint.yml`](../../.github/workflows/dashboard-alert-lint.yml),
which runs on pushes and pull requests that touch `docs/dashboards/**`.
